...
class CV_Enhanced_Review {
    ...
    public function enqueue_assets() {
        if ( is_product() ) {
            wp_enqueue_style( 'cver-style', plugins_url( 'assets/css/cver-style.css', __FILE__ ), array(), '1.1.1' );
            wp_enqueue_script( 'cver-script', plugins_url( 'assets/js/cver-script.js', __FILE__ ), array('jquery'), '1.1.1', true );
